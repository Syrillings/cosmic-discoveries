  ...
  const observatories = [
    {
      ...
      location: "Hawaii, USA",
      description:
        "Home to the world's largest optical telescope, situated at 4,205 meters above sea level.",
    ...
    },
    {
      ...
      description:
        "One of the world's premier radio astronomy observatories, consisting of 27 radio antennas.",
    ...
    },
    {
      ...
      description:
        "The world's most productive ground-based astronomical facility, located in the driest desert.",
    ...
    },
    {
      ...
      description:
        "Home to the Very Large Telescope (VLT), the world's most advanced optical instrument.",
        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              World's Leading Observatories
            </h1>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Discover the most advanced astronomical observatories around the
              globe, where scientists peer into the depths of space to unravel
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-24">
          ...
          {observatories.map((observatory) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-gray-300 mb-4">{observatory.description}</p>
        ...
        <div className="mt-20 max-w-7xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-bold mb-6 text-center">
            Map of the World's Observatories
          </h1>
          <div className="mt-10 flex justify-center relative">
            ...
            <div className="rounded-2xl overflow-hidden h-[500px] w-full">
              <iframe
                src="https://data.opendatasoft.com/explore/embed/dataset/eso-astronomical-observatory-sites@datastro/map/?disjunctive.instruments&basemap=jawg.streets&location=2,9.79568,-0.17578&static=false&datasetcard=false&scrollWheelZoom=false"
